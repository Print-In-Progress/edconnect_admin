import 'package:edconnect_admin/components/card.dart';
import 'package:edconnect_admin/models/providers/themeprovider.dart';
import 'package:edconnect_admin/models/user.dart';
import 'package:edconnect_admin/pages/settings_pages/settings_main_page.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return IconButton(
      onPressed: () {
        ...
        ref.read(themeProvider.notifier).updateTheme(!isDarkMode);
      },
      icon: isDarkMode
