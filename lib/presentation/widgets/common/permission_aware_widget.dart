...
// /// Widget that only shows its child if user has access to a specific feature
// class FeatureAwareWidget extends ConsumerWidget {
//   /// Feature ID from Permissions.featurePermissionSets
//   final String featureId;

//   /// Widget to show if user has access to feature
//   final Widget child;

//   /// Optional widget to show if access is denied
//   final Widget? fallback;

//   const FeatureAwareWidget({
//     super.key,
...
//     // Get required permissions for this feature
//     final requiredPermissionIds = Permissions.featurePermissionSets[featureId];

//     if (requiredPermissionIds == null || requiredPermissionIds.isEmpty) {
//       return fallback ?? const SizedBox.shrink();
//     }

//     // Check if user has admin or any required permission
//     final hasAccess = userPermissions.contains(Permissions.admin.id) ||
//         requiredPermissionIds.any((p) => userPermissions.contains(p));
